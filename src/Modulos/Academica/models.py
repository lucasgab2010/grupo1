...
class Carrera(models.Model):
    ...
    def __str__(self):
        ...
        return txt.format(self.nombre, self.duracion) #self.nombre
...
class Estudiante(models.Model):
    ...
    def __str__(self):
        ...
        return txt.format(self.nombreCompleto(), estadoEstudiante, self.carrera)
...
class Matricula(models.Model):
    ...
    def __str__(self):
        txt = "{0} matriculad{1} en el curso {2} / Feche: {3}"
